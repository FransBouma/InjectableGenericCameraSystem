...
namespace IGCS::DX11Hooker
{
	...
	void initImGuiStyle()
	{
		...
		style.Colors[ImGuiCol_WindowBg] = ImVec4(0.04f, 0.04f, 0.07f, 0.84f);
		...
		style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.40f, 0.40f, 0.47f, 0.44f);
		...
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.59f, 0.59f, 0.59f, 0.30f);
		style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.59f, 0.59f, 0.59f, 1.00f);
		style.Colors[ImGuiCol_Button] = ImVec4(0.24f, 0.24f, 0.27f, 0.69f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.33f, 0.33f, 0.36f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.56f, 0.56f, 0.58f, 1.00f);
		style.Colors[ImGuiCol_Header] = ImVec4(0.40f, 0.40f, 0.44f, 0.45f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.40f, 0.40f, 0.44f, 1.00f);
