...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
		...
		*/
		// the compiled vertex shader, in bytes. See: https://github.com/ocornut/imgui/pull/638#issuecomment-217671027
		...
		psoDesc.VS = { vertexBuffer, sizeof(vertexBuffer) };
    ...
    // Create the pixel shader
    {
		...
		*/
		// the compiled pixel shader, in bytes. See: https://github.com/ocornut/imgui/pull/638#issuecomment-217671027
		...
		psoDesc.PS = { shaderBlob, sizeof(shaderBlob) };
    }
